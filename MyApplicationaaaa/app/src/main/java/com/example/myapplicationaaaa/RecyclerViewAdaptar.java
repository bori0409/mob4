...
public class RecyclerViewAdaptar<T> extends RecyclerView.Adapter<RecyclerViewAdaptar<T>.MyViewHolder> {
    private static final String LOG_TAG = "ADAPTER";
    private final List<T> data;
    private OnItemClickListener onItemClickListener;
    private final int viewId = View.generateViewId();

    public RecyclerViewAdaptar(List<T> data) {
        this.data = data;
    ...
    @NonNull
    @Override
    public RecyclerViewAdaptar<T>.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
